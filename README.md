...
The target presentation time is iteratively calculated using the Quest algorithm, implemented in lines 332-339. See [PsychoPy docs](https://psychopy.org/_modules/psychopy/data/staircase.html#QuestHandler) for parameter details.
